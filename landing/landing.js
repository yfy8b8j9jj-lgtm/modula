...
const MODS = [
  ...
  {id:'conti', ic:'💰', nm:'Conti', px:15, pitch:'Entrate, spese e utile sempre sotto controllo.',
  ...
  {id:'man', ic:'🔧', nm:'Manutenzioni', px:25, pitch:'Interventi, assistenza e storico, senza più foglietti.',
  ...
  {id:'macchine', ic:'⚙️', nm:'Macchine / Impianti', px:25, pitch:'Il parco macchine con schede e scadenze.',
  ...
  {id:'pellet', ic:'🪵', nm:'Consegne', px:25, pitch:'Consegne, bolle e firma, dal telefono.',
  ...
  {id:'sites', ic:'🏗', nm:'Cantieri / Commesse', px:39, pitch:'Lavori in corso con ore, costi e avanzamento.',
  ...
  {id:'zone', ic:'🗺️', nm:'Zone & Mappa', px:39, pitch:'I tuoi clienti sulla mappa, i giri ottimizzati.',
